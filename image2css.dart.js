...
static:{kX:function(a){return H.Gy(P.EF(["command","print","msg",a],null,null))}}},
aX:{
...
"^":"",
K0:function(a,b,c){if(b<0||b>a.length)throw H.b(P.TE(b,0,a.length,null,null))
...
P.JS("ready")
z=document.querySelector("#imageInput")
y=document.querySelector("#cssImage")
x=document.querySelector("#pixelSizeInput")
w=new R.wI(new FileReader(),z,x,y,null)
w.mT=H.Hp(J.Vm(x),null,null)
w.v4()},"$0","KW",0,0,7],
ML:function(a){if(a===$.I3)return new R.nh(null)
throw H.b(R.ED())},
wI:{
"^":"a;NU,KG,Pi,wW,mT",
v4:function(){var z=J.uX(this.KG)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new R.Ki(this)),z.el),[H.Kp(z,0)]).DN()
z=J.uX(this.Pi)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new R.u2(this)),z.el),[H.Kp(z,0)]).DN()},
Yz:function(){var z,y,x
z=J.co(this.KG)
if(0>=z.length)return H.e(z,0)
y=z[0]
z=this.NU
x=H.VM(new W.RO(z,"load",!1),[null])
H.VM(new W.xC(0,x.J6,x.fA,W.VF(new R.r8(this)),x.el),[H.Kp(x,0)]).DN()
z.readAsArrayBuffer(y)},
cd:function(a){var z,y,x,w
z=this.V0(a)
try{y=R.ML(z)
x=y.jD(a,this.mT)
J.cm(this.wW.style,x)}catch(w){if(!!J.x(H.Ru(w)).$isTD)window.alert("Unsupported image type")
else throw w}},
V0:function(a){var z,y,x,w,v
z=J.Wh(a,0,2).br(0)
for(y=z.length,x=0,w=0;w<y;++w){v=z[w]
if(typeof v!=="number")return v.i()
x=(x<<8>>>0)+(v&255)}return x}},
Ki:{
"^":"Tp:9;a",
...
z.mT=H.Hp(J.Vm(z.Pi),null,null)
z.Yz()}},
r8:{
"^":"Tp:9;a",
$1:function(a){var z=this.a
return z.cd(C.Uy.gyG(z.NU))}},
Vx:{
"^":"a;"},
TD:{
"^":"a;",
$isTD:true,
static:{ED:function(){return new R.TD()}}},
nh:{
"^":"Vx;mT",
jD:function(a,b){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l
this.mT=b
z=this.Hq(J.w1(a).Mu(a,18,22).br(0))
y=this.Hq(C.NA.Mu(a,22,26).br(0))
x=y*z
w=P.p9("")
for(v=y-1,u=54,t=0;v>=0;--v)for(s=0;s<z;++s,u=r){r=u+3
q=C.NA.Mu(a,u,r).br(0)
...
l=q+H.d(v*l)+"px "+H.d(this.mT)+"px "+H.d(this.mT)+"px "+m
q=w.IN+=l
if(t!==x)w.IN=q+","}q=w.IN
return q.charCodeAt(0)==0?q:q},
Hq:function(a){var z,y,x,w
for(z=a.length,y=0,x=0;x<z;++x){w=a[x]
if(typeof w!=="number")return w.i()
y+=C.jn.iK(w&255,8*x)}return y}}},1],])
...
init.metadata=[{func:"uO",args:[P.qU]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(function(b){H.Rq(R.KW(),b)},[])}else{(function(b){H.Rq(R.KW(),b)})([])}})
})()
